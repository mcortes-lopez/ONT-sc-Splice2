...
path.to.three.outputs = paste0(path.to.outputs, "/alt_three_prime/", sep = "")
#path.to.five.outputs = paste0(path.to.outputs, "/alt_five_prime/", sep = "")
...
metadata$exon_coordinates = paste(metadata$chr, metadata$start, metadata$end, metadata$strand, sep = ":")
