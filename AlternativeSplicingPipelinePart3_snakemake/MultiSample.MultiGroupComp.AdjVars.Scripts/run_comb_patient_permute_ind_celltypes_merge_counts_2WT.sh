...
Rscript "$runfiles"/combined_patient_permute_merge_reads_ind_celltypes_2WT.R $splitfiles $cell_metadata $comp_groups_column $cell_groups_column $nperm $samples $outdir $outfile
