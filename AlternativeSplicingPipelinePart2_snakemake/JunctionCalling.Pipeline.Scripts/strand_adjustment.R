...
#load in metadata 
all_introns_meta = read.csv(path.to.metadata, row.names = 1, stringsAsFactors = F)
...
all_introns_meta$startDistance <- as.integer(all_introns_meta$startDistance)
all_introns_meta$endDistance <- as.integer(all_introns_meta$endDistance)
